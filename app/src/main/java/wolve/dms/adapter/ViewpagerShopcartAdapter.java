...
public class ViewpagerShopcartAdapter extends PagerAdapter {
    ...
    public ViewpagerShopcartAdapter(List<CartProductDialogAdapter> listAdapter, List<ProductGroup> productGroups){
