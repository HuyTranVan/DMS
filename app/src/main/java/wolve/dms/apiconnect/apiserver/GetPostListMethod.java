 ...
 */
public class GetPostListMethod extends AsyncTask<String, Void, List<String>> {
    private CallbackCustomList mListener = null;
    private List<BaseModel> mParams;
    private GetPostListMethod main;

    public GetPostListMethod(List<BaseModel> listParams, CallbackCustomList listener, int loadingtimes) {
            ...
            Util.showLongSnackbar("No internet!",
                    ...
                    new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            new GetPostListMethod(mParams, mListener, loadingtimes);
                        }
                    });
