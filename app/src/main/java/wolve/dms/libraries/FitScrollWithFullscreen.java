...
public class FitScrollWithFullscreen {
    ...
    private FitScrollWithFullscreen(Activity activity, final int fixNumber) {
    ...
    private void possiblyResizeChildOfContent(int fixNumber) {
        ...
        if (usableHeightNow != usableHeightPrevious) {
            ...
            if (heightDifference > (usableHeightSansKeyboard/4)) {
                ...
                frameLayoutParams.height = usableHeightSansKeyboard - heightDifference/fixNumber;
            } else {
