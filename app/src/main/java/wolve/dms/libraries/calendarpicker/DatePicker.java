...
//        mLayout = findViewById(R.id.datepicker_parent);
//
//        mDayPicker = (NumberPicker) mLayout.findViewById(R.id.day);
...
//                    didDay = true;
//                } else if ((c == android.icu.text.DateFormat.MONTH || c == 'L') && !didMonth) {
//                    parent.addView(mMonthPicker);
//                    didMonth = true;
//                } else if (c == android.icu.text.DateFormat.YEAR && !didYear) {
